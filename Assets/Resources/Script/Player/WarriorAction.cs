...
public class WarriorAction : PlayerAction
{
    ...
    {      
        ...
        Effect.transform.localPosition = TouchAttack_Pos.transform.position;
    ...
    void Create_TouchAttackEffect()
    {
        ...
        Effect.GetComponent<Warrior_TouchAttackEffect_Action>().Attack = Init_Infomation.Touch_value;
